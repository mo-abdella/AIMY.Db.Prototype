...
//            //tool.ApiKey = "sehab@uplandsoftware.com";
//            //tool.ApiSecret = EncryptApiSecret("mUaD5qK8QWoHrRXHItQi5JTZpB7HdMvfPTL6zE5g").Result;
//            //tool.CreatedBy = "mo has something";
//            //tool.UpdatedBy = "mo has something";
//            //tool.Name = "Zendesk";

//            //var product = await _context.Products.FirstOrDefaultAsync(p => p.Id == 2);
