...
public partial class MyDbContext : DbContext
{
    ...
    public virtual DbSet<AnalysisRuleProduct> AnalysisRuleProducts { get; set; }
    ...
    public virtual DbSet<ProductTool> ProductTools { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseNpgsql("Host=aimyqa-postgresql-db.cjcuyweio8o4.us-east-1.rds.amazonaws.com;Database=aimyqa;Username=postgres;Password=dsnWhRsVcaSXZR4DSHmGbaLn6;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AnalysisRuleProduct>(entity =>
        {
            entity.HasKey(e => new { e.AnalysisRuleId, e.ProductId }).HasName("analysis_rule_product_pkey");

            entity.ToTable("analysis_rule_product", "rule");

            entity.HasIndex(e => e.ProductId, "idx_analysis_rule_product_product_id");
            ...
            entity.HasOne(d => d.AnalysisRule).WithMany(p => p.AnalysisRuleProducts)
                .HasForeignKey(d => d.AnalysisRuleId)
                .HasConstraintName("analysis_rule_product_analysis_rule_id_fkey");

            entity.HasOne(d => d.Product).WithMany(p => p.AnalysisRuleProducts)
        ...
        {
            entity.HasKey(e => e.Id).HasName("product_tool_pkey");

            entity.ToTable("product_tool", "product");

            entity.HasIndex(e => e.ClientId, "idx_product_tool_client_id");

            entity.HasIndex(e => e.OrganizationId, "idx_product_tool_organization_id");

            entity.HasIndex(e => e.ProductId, "idx_product_tool_product_id");

            entity.HasIndex(e => e.ToolId, "idx_product_tool_tool_id");
            ...
            entity.HasOne(d => d.Client).WithMany(p => p.ProductTools)
                .HasForeignKey(d => d.ClientId)
                .HasConstraintName("product_tool_client_id_fkey");

            entity.HasOne(d => d.Organization).WithMany(p => p.ProductTools)
                .HasForeignKey(d => d.OrganizationId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("product_tool_organization_id_fkey");

            entity.HasOne(d => d.Product).WithMany(p => p.ProductTools)
                .HasForeignKey(d => d.ProductId)
                .HasConstraintName("product_tool_product_id_fkey");

            entity.HasOne(d => d.Tool).WithMany(p => p.ProductTools)
                .HasForeignKey(d => d.ToolId)
        ...
        {
            entity.HasKey(e => e.Id).HasName("product_user_pkey");

            entity.ToTable("product_user", "product");

            entity.HasIndex(e => e.ClientId, "idx_product_user_client_id");

            entity.HasIndex(e => e.OrganizationId, "idx_product_user_organization_id");
            ...
            entity.HasOne(d => d.Client).WithMany(p => p.ProductUsers)
                .HasForeignKey(d => d.ClientId)
                .HasConstraintName("product_user_client_id_fkey");

            entity.HasOne(d => d.Organization).WithMany(p => p.ProductUsers)
                .HasForeignKey(d => d.OrganizationId)
